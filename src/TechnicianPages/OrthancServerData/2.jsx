...
//   // Match characters and allowed punctuation, continuing through spaces, dots, or carets
//   const match = fullString.match(/^[a-zA-Z.\^ ]+/);
//   if (!match) return null;

//   // Replace non-alphabetic characters (like dots or carets) with spaces, then remove extra spaces
//   return match[0]
//     .replace(/[^a-zA-Z ]+/g, " ")
//     .replace(/\s+/g, " ")
//     .trim();
